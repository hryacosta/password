...
void main() {
  group('AuthRemoteDataSource', () {
    ...
    group('signIn', () {
      const tCredential =
          CredentialModel(username: 'test', password: 'password');
      ...
      test('should return SessionModel when the call is successful', () async {
        ...
        final result = await dataSource.signIn(tCredential);
      ...
      test('should throw DioException when the call is unsuccessful', () async {
        ...
        expect(
          () async => dataSource.signIn(tCredential),
